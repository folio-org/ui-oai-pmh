...
describe('Sets list', () => {
  ...
  it('should show epmty list', () => {
    ...
    expect(screen.getByText('ui-oai-pmh.settings.sets.list.no.sets')).toBeVisible();
  });

  it('should be correct pane header title', () => {
    renderSetList(1);

    expect(screen.getByText('ui-oai-pmh.settings.sets.list.title')).toBeVisible();
  });
  ...
  it('should be correct label text for tabel', () => {
    ...
    const labels = [
      'ui-oai-pmh.settings.sets.list.field.name',
      'ui-oai-pmh.settings.sets.list.field.setSpec',
      'ui-oai-pmh.settings.sets.list.field.description',
